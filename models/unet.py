...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.up1 = Up(1024//2, 512 // 2, bilinear)
        self.up2 = Up(512//2, 256 // 2, bilinear)
        self.up3 = Up(256//2, 128 // 2, bilinear)
...
if __name__ == '__main__':
    ...
    print(fr'out_shape:{net(kk).shape}，flops:{flops}, params:{params}')
