...
train = BasicDataset(train_dir_img, train_dir_mask)
test = BasicDataset(test_dir_img, test_dir_mask)

train_loader = DataLoader(train, batch_size=batchsize, shuffle=True, num_workers=16, pin_memory=True)
test_loader = DataLoader(test, batch_size=batchsize, shuffle=False, num_workers=16, pin_memory=True)
